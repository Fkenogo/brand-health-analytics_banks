...
export const CompetitiveBanner: React.FC<CompetitiveBannerProps> = ({
  moduleSummary,
  marketShare,
  multiBankingRate,
  selectedRank,
  ...
  const metrics = [
    { label: 'Market Share', value: fmtPct(marketShare) },
    { label: 'Multi-Banking Rate', value: fmtPct(multiBankingRate) },
    { label: 'Market Rank', value: selectedRank !== null ? `#${selectedRank} of ${totalBanks}` : '—' },
  ];
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:gap-8">
        ...
        <div className="flex-shrink-0 lg:w-48">
          {positionLabel && positionLabel !== 'N/A' ? (
            ...
            <div className="mb-3 inline-block rounded-full border border-[#E4E7EC] bg-[#F9FAFB] px-3 py-1">
              <span className="text-[11px] font-bold uppercase tracking-widest text-[#667085]">COMPETITIVE</span>
            </div>
          )}
          {/* Fixed: was missing uppercase tracking-widest */}
        ...
        <div className="min-w-0 flex-1">
          ...
          {takeaway ? (
            ...
            <p className="text-sm text-[#667085]">No competitive data available for this selection.</p>
          )}
        </div>
